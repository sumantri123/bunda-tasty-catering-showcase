                    ...
                    <div class="row g-3">
						<div class="col-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bxs-plus-square' ></i></span>
                                <select class="{{$data['classFormSelect']}} clearDisable" name="kat_barang_keluar" id="kat_barang_keluar" >
									@foreach($barang_keluar as $datax)
									<option value="{{ $datax->id }}" >{{ ucfirst(trans($datax->nama_perkiraan)) }}</option>
									@endforeach                                                                                                    
								</select>
                            </div>
                            <label for="kat_barang_keluar" generated="true" class="error"></label>
                            <label id="validationError"></label>
                        </div>
                        <div class="col-12">
                            <label for="inputPhoneNo" class="form-label"><b>Nama Barang</b></label>
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bxs-plus-square' ></i></span>
...
<script src="{{ asset('additional/js/beli_barang/beli_barang.js?v=1.01') }}"></script>
