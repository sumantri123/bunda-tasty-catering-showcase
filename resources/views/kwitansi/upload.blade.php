...
<div class="card border-top border-0 border-4 border-primary">
    <div class="card-body">
        <div class="table-responsive">            
			...
			<input type="hidden" class="form-control" id="idKw" value="{{$data['idKw']}}" name="idKw">			
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" id="data_form" method="post" enctype="multipart/form-data">
                <div class="modal-body">                
                    ...
                    <input type="hidden" class="form-control" id="id" value="{{$data['idKw']}}" name="id">
...
<script src="{{ asset('additional/js/kwitansi/list_bt.js') }}"></script>
