...
<div class="card border-top border-0 border-4 border-primary">
    <div class="card-body">
        <div class="table-responsive">
            <button id="tambah" class="{{$data['btnClass']}}">{{$data['btnAdd']}}</button>
			<button id="tes" class="{{$data['btnClass']}}">tes</button><br><br>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" id="form_edit_perkiraan" method="post">
                <div class="modal-body">                
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <label for="inputPhoneNo" class="form-label"><b>Company</b></label>
...
<script src="{{ asset('additional/js/customer/customer.js') }}"></script>
