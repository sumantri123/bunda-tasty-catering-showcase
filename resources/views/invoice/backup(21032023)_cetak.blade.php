					...
					<table class="styled-table">
						...
						@foreach($data as $datax)
							<tr>
								...
								<td style="background-color:white;" align="right">{{number_format($datax->total)}}</td>
							</tr>
						@endforeach
						<tr>
						...
						<tr>
							<td colspan="5" class="bg-primary" style="-webkit-print-color-adjust: exact; color:white;font-weight:bold;">Discount</td>														
							<td align="right" class="bg-primary" style="-webkit-print-color-adjust: exact; color:white;font-weight:bold;">{{number_format($data[0]->invoice_nominal)}}</td>
						</tr>
						<tr>
							<td colspan="5" class="bg-primary" style="-webkit-print-color-adjust: exact; color:white;font-weight:bold;">Grand Total</td>														
							<td align="right" class="bg-primary" style="-webkit-print-color-adjust: exact; color:white;font-weight:bold;">{{number_format($data[0]->grand_total - $data[0]->invoice_nominal)}}</td>
						</tr>
					</table>
					<br>
					<div class="notices">
