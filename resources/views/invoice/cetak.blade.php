			...
			<div style="min-width: 600px">
				...
				<main>
					...
					<table class="styled-table">
						...
						<tr>
							<td colspan="4" class="bg-primary" style="-webkit-print-color-adjust: exact; color:white;font-weight:bold;">PPN {{$data[0]->invoice_pajak_persen}} %</td>														
							<td align="right" class="bg-primary" style="-webkit-print-color-adjust: exact; color:white;font-weight:bold;">{{number_format($data[0]->total_pajak)}}</td>
						</tr>
						<tr>
							<td colspan="4" class="bg-primary" style="-webkit-print-color-adjust: exact; color:white;font-weight:bold;">Discount</td>														
