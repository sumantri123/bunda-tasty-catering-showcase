                    ...
                    <div id="transContent" style="min-width: 600px">
                        ...
                        <main>
                            <form class="form-horizontal form-label-left" id="formEntry" method="post">    
								...
								<input type="hidden" class="form-control" id="idPenawaran" name="idPenawaran" value="{{$data['idPenawaran']}}" />													
                                ...
                                <div class="row form_custom">                                     
                                    <div class="col-md-3">
										...
										<input type="hidden" class="{{$data['classFormControl']}}" id="id_jurnal_bagian" value="{{$data['idJurnalBagian']}}" name="id_jurnal_bagian">    
                                    ...
                                    <div class="col-md-6">
                                        <label for="inputCity" class="form-label" style="color:blue; font-weight:bold">Vendor</label>
                                        @if (($supplier)->isEmpty())
                                        <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show">
                                            <div class="text-white">Data Vendor Tidak Ada</div>
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>
                                        @else
                                            <select class="{{$data['classFormSelect2']}} clearDisable" name="supplier" id="supplier" >
                                                <option value=""></option>
                                                @foreach($supplier as $data)
                                                <option value="{{ $data->supplier_id }}" >{{ ucfirst(trans($data->supplier_nama)) }}</option>
                                                @endforeach                                                                                                    
                                            </select>                                            
                                        @endif
                                    </div>                                
									<div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="perihal" value="" placeholder="" name="perihal">    
...
<script src="{{ asset('additional/js/pemesanan/add_pemesanan.js') }}"></script>
