                            ...
                            <form class="form-horizontal form-label-left" id="formEntry" method="post">    
                                ...
                                <div class="row form_custom">                                     
									...
									<div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="perihal" value="" placeholder="Penawaran Catering" name="perihal">    
									...
									<div class="col-md-12">
										...
										<input type="text" class="form-control form-control-sm" id="ttd" value="Manager Bunda Tasty Catering" onkeydown="upperCaseF(this)" name="ttd">    									
									...
									<div class="col-md-3">
										...
										<input type="text" class="form-control form-control-sm" id="telp" value="" name="telp">
										<input type="hidden" id="jumlahData" name="jumlahData" class="form-control form-control-sm" readonly>
...
<script src="{{ asset('additional/js/penawaran/add_penawaran.js?v=1.09') }}"></script>
