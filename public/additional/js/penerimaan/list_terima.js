...
$(document).ready(function () {
	...
	$('#data_form').submit(function(e) {
		...
		var action_url = "" + base_url + "/saveTerima";
    ...
    function loadData() {
            ...
            ajax: {
                "url": "" + base_url + '/getDataJson/dokTerima',
                'type': 'GET',
                'dataType': 'JSON',
            ...
            columns: [
            {
                ...
                render: function (data, type, full, meta) {
					...
					result +=
                        '<button class="btn btn-primary  btn-sm btn-upload" title="Upload PO"><i class="bx bx-search me-0"></i></button>&nbsp;';                    
                    result +=
    ...
    function deleteProses(id) {
        $.ajax({
            type: 'GET',
            url: "" + base_url + "/delete/dokTerima/" + id,
            dataType: 'JSON',
