...
$(document).ready(function () {
	...
	$('#data_form').submit(function(e) {
		...
		var action_url = "" + base_url + "/saveFaktur";
    ...
    function loadData() {
            ...
            ajax: {
                "url": "" + base_url + '/getDataJson/dokFaktur/'+idInvoice,
                'type': 'GET',
                'dataType': 'JSON',
            ...
            columns: [
            {
                ...
                render: function (data, type, full, meta) {
					...
					result +=
                        '<button class="btn btn-primary  btn-sm btn-upload" title="Upload Faktur"><i class="bx bx-search me-0"></i></button>&nbsp;';                    
                    result +=
