...
$(document).ready(function () {
    ...
    function loadData() {
        ...
        data_table  = $('#example2').DataTable({            
            ...
            ajax: {
                "url": "" + base_url + '/getDataJson/sosmed',
                'type': 'GET',
                'dataType': 'JSON',
            ...
            "drawCallback": function (settings) {
                $('.btn-edit').on('click', function () {
                    ...
                    $('#id').val(data.sosmed_id);
                    $('#jenis').val(data.sosmed_jenis);
					$('#akun').val(data.sosmed_akun);					
                    $('#link').val(data.sosmed_link);						
                ...
                $('.btn-delete').on('click', function () {
                    ...
                    Lobibox.confirm({
                        iconClass: true,
                        title: 'Delete Data',                        
                        msg: 'Yakin Hapus Data "' + data.sosmed_jenis + '"?',
                        callback: function ($this, type, ev) {
                            if(type=='yes'){
                                deleteProses(data.sosmed_id);
                            }        
                        }
                    }); 
    ...
    function insertUpdateProses() {
        ...
        if (form.valid() == true) {
            ...
            var action_url = "" + base_url + "/sosmed";            
            var action_type = "Tambah";
            if (method === "PUT") {
                action_url = "" + base_url + "/sosmed/" + $('#id').val();
                action_type = "Ubah";
            }
